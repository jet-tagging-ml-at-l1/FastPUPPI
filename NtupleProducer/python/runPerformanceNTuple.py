...
def addMultitagging(): #extended TRK
    ...
    process.l1tMultiJetProducerPuppiCorrectedEmulator.MultiJetPath = cms.string("/builds/ml_l1/TrainTagger/CMSSW_14_0_0_pre3/src/hls4ml-jettagger/MultiJetBaseline")
